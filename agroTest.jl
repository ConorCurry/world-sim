...
@show rootMap[1,1]
@time zoomMap = AgroGame.zoom(AgroGame.MapTile(0xFF, 0xFF), MAPSIZE)
...
IMAGESIZE = (0x200, 0x200)
printMap(rootMap, "rootMap", IMAGESIZE)
printMap(zoomMap, "zoomMap", IMAGESIZE)
